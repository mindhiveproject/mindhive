...
export const SURFACES = [
  ...
  },
  {
    ...
    label: "Connect — opportunity bank",
    routes: DASHBOARD,
    areas: ["connect"],
  ...
  {
    key: "dashboard.connect.my",
    label: "My saved connections",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["my"],
    root: "components/Dashboard/Connect/Connections/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.with",
    label: "Someone's Connect profile",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["with"],
    root: "components/Dashboard/Connect/ProfilePage/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.profile",
    label: "My Connect profile",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["profile"],
    root: "components/Dashboard/Connect/MyProfile/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.questions",
    label: "Question library",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["questions"],
    root: "components/Dashboard/Connect/Questions/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.matches",
    label: "Matches",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["matches"],
    root: "components/Dashboard/Connect/Matches/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.my-matches",
    label: "My matched students",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["my-matches"],
    root: "components/Dashboard/Connect/MentorMatches/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.explore",
    label: "Explore opportunities (staff)",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["explore"],
    root: "components/Dashboard/Connect/ExploreForStaff",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.organizations",
    label: "Organizations",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["organizations"],
    root: "components/Dashboard/Connect/Organizations/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.manage-organization",
    label: "Manage an organization",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["manage-organization"],
    root: "components/Dashboard/Connect/Organizations/ManageMain",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.networks",
    label: "Class networks",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["networks"],
    root: "components/Dashboard/Connect/ClassNetworks/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.review-queue",
    label: "Review queue",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["review-queue"],
    root: "components/Dashboard/Connect/ReviewQueue/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.connect.review",
    label: "Review an opportunity",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["connect"],
    selectors: ["review"],
    root: "components/Dashboard/Connect/ReviewOpportunity/Main",
    figmaNodeId: null,
  },
  {
  ...
  {
    key: "dashboard.settings.email",
    label: "Change email",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["settings"],
    selectors: ["email"],
    root: "components/Dashboard/Settings/Email",
    figmaNodeId: null,
  },
  {
    key: "dashboard.settings.username",
    label: "Change username",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["settings"],
    selectors: ["username"],
    root: "components/Dashboard/Settings/Username",
    figmaNodeId: null,
  },
  {
    key: "dashboard.settings.languages",
    label: "Language settings",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["settings"],
    selectors: ["languages"],
    root: "components/Dashboard/Settings/Languages",
    figmaNodeId: null,
  },
  {
    key: "dashboard.settings.consent",
    label: "Consent settings",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["settings"],
    selectors: ["consent"],
    root: "components/Dashboard/Settings/Consent",
    figmaNodeId: null,
  },
  {
  ...
  // ---- Dashboard, admin-only areas ---------------------------------------
  {
    ...
    label: "Management — classes (admin)",
    routes: DASHBOARD,
    areas: ["management"],
  ...
  {
    key: "dashboard.management.networks",
    label: "Management — networks (admin)",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["management"],
    selectors: ["networks"],
    root: "components/Dashboard/Management/Networks/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.management.assignments",
    label: "Management — assignments (admin)",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["management"],
    selectors: ["assignments"],
    root: "components/Dashboard/Management/Assignments/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.management.blockdocumentation",
    label: "Management — block documentation (admin)",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["management"],
    selectors: ["blockdocumentation"],
    root: "components/Dashboard/Management/BlockDocumentation/Main",
    figmaNodeId: null,
  },
  {
    key: "dashboard.management.users",
    label: "Management — users (admin)",
    routes: ["/dashboard/[area]/[selector]"],
    areas: ["management"],
    selectors: ["users"],
    root: "components/Dashboard/Management/Users/Main",
    figmaNodeId: null,
  },
  {
...
/**
 * A surface key and its dotted ancestors, most specific first:
 * `builder.projects.start` → `builder.projects.start`, `builder.projects`,
 * `builder`. The Figma map (SurfaceDesign) is looked up along this chain, so a
 * surface with no link of its own inherits its nearest ancestor's. Keep in step
 * with `rememberSurfaceDesign` in keystone/schemas/Ticket.ts.
 */
export function designKeysFor(key) {
