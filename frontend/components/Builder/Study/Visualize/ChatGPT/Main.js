...
export default function ChatGPT({ spec, setSpec, data }) {
    ...
    async function GPTCall(text) {
        ...
        { role: 'user', content: text + ". The data includes different tags nested within each other. Each key is a different task conducted by a participant of the study. This is the data: " + JSON.stringify(dataForGPT) }];
    ...
    return (
        <StyledChatGPTPage>
            <div>
                ...
                <p className="subtitle">Type in natural language the graph that you’d like or ask for the best graph for your data</p>
