...
const SELECT_ONE_CLEAR_SENTINEL = "__mh_statistics_select_one_clear__";
...
export default function SelectOne({
  ...
  const dropdownOptions = useMemo(() => {
    const clearLabel = t(`${STATS_FIELDS}.clearSelection`, {}, { default: "None" });
    const clearRow = {
  ...
  const placeholder = t(
    `${STATS_FIELDS}.selectPlaceholder`,
    { field: title },
