            ...
            if (
                ...
                switch (tab) {
                    ...
                    case 'visualize': // will be deprecated
                        try {
                            componentImport = await import('../../Builder/Project/Visualize/Wrapper.js');
                        } catch (error) {
              ...
              if (currentLocale !== "en-us") {
                try {
                  participantPageToursImport = await import(
                    `../../Builder/Project/ParticipantPage/tour.${currentLocale}.js`
                  );
                } catch (localizedError) {
                  // Fallback to English
                  participantPageToursImport = await import(
                    "../../Builder/Project/ParticipantPage/tour.js"
                  );
                }
              } else {
                participantPageToursImport = await import(
              ...
              if (currentLocale !== "en-us") {
                try {
                  reviewToursImport = await import(
                    `../../Builder/Project/Review/tour.${currentLocale}.js`
                  );
                } catch (localizedError) {
                  // Fallback to English
                  reviewToursImport = await import(
                    "../../Builder/Project/Review/tour.js"
                  );
                }
              } else {
                reviewToursImport = await import(
              ...
              if (currentLocale !== "en-us") {
                try {
                  collectToursImport = await import(
                    `../../Builder/Project/Collect/tour.${currentLocale}.js`
                  );
                } catch (localizedError) {
                  // Fallback to English
                  collectToursImport = await import(
                    "../../Builder/Project/Collect/tour.js"
                  );
                }
              } else {
                collectToursImport = await import(
